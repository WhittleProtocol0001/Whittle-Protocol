...
igt_1spl_Maps(var height, var delISA, var mdot,var cmPr,var TET, var Mach, var delP_i, var delP_cmb,var delP_nzl,
  ...
  return[TW,SpecificPower*1000000,Turbine[0], scaled_compressor_maps, scaled_turbine_maps, scaled_pwt_maps, Combustor[7],Combustor[4],Combustor[6],Combustor[1],Compressor[4],eta_45, Inlet[2], Nozzle[2]];
