...
turbofan_2spl_Maps(var height, var delISA, var mdot,var cmPr_fan_hub,var cmPr_fan_bp,var cmPr1,var cmPr2,var TET, var BPR,
...
//  cmPBetaPR(Inlet[4],Inlet[3],cmPrLPC,eta2_25,Inlet[0],beta_selected_LPC,nc_des_cmp_selected_LPC);
  fan_bypass=FanBPBetaPR(Inlet[5],Inlet[4],cmPr_fan_bp,eta_18,Inlet[1],beta_fan_bp,ncdes_fan_bp,FanBypassBetaPrMap());
...
//  Nozzle_bypass=nozArb(D_BP[2],D_BP[0],D_BP[1],0.0, atmosphere(height)[1],0,1);
  ...
  fan_hub=FanCoreBetaPR(Inlet[5],Inlet[4],cmPr_fan_hub,eta_18_hub,Inlet[0], beta_fan_core, ncdes_fan_core, FanCoreBetaPrMap());


  //LPC-->[cp_guess,cp_guess1,T2,T2i,CW,P2,mdot];

  LPC=IPCBetaPR(fan_hub[2],fan_hub[5],cmPr1,eta_2_25,fan_hub[6], beta_ipc, ncdes_ipc,IPCBetaPrMap());
  ...
  HPC=cmPBetaPR(D1[1], D1[0], cmPr2, eta_25_3, D1[2], beta_hpc, ncdes_hpc);
  ...
  HPT=HPTTurBZetaPR(CB_rmod[2],CB_rmod[1],CB_rmod[0],CB_rmod[3],HPC[4],eta_4_45,eta_mech,fuel_type,
  ...
  LPT=LPTTurBZetaPR(D2[0],D2[1],D2[2],CB_rmod[3],LPC[4]+fan_bypass[4]+fan_hub[4],eta_45_5,eta_mech,fuel_type, nc_des_turb_selected_LPT, zeta_selected_LPT);
  ...
  var scaled_compressor_maps_FAN_BP = [fan_bypass[8], fan_bypass[9], fan_bypass[10]];
  var scaled_compressor_maps_FAN_CORE = [fan_hub[8], fan_hub[9], fan_hub[10]];
  var scaled_compressor_maps_LPC = [LPC[8], LPC[9], LPC[10]];
  var scaled_compressor_maps_HPC = [HPC[8], HPC[9], HPC[10]];


  // Wc, eff
  var scaled_turbine_maps_HPT = [HPT[5], HPT[6]];
  var scaled_turbine_maps_LPT = [LPT[5], LPT[6]];


  return[Fn,SFC,HPT[0], scaled_compressor_maps_FAN_BP, scaled_compressor_maps_FAN_CORE, scaled_compressor_maps_LPC, scaled_compressor_maps_HPC, scaled_turbine_maps_HPT, scaled_turbine_maps_LPT,Combustor[7],
    Combustor[4],Combustor[6],Combustor[1], LPC[4],eta_4_45, Inlet[3], Inlet[6],Nozzle[2], Nozzle_bypass[2], Inlet[7], Inlet[8]];
